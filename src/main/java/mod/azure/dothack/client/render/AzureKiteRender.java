...
public class AzureKiteRender extends MobRenderer<NPCEntity, NPCModel<NPCEntity>> {

	protected static final ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID,
			"textures/entity/azurekite.png");

	public AzureKiteRender(EntityRendererManager renderManagerIn) {
