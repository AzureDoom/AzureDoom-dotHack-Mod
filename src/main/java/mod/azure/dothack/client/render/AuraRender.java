...
public class AuraRender extends MobRenderer<NPCEntity, NPCModel<NPCEntity>> {

	protected static final ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID,
			"textures/entity/aura.png");

	public AuraRender(EntityRendererManager renderManagerIn) {
