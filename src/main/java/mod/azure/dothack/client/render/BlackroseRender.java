...
public class BlackroseRender extends MobRenderer<NPCEntity, NPCModel<NPCEntity>> {

	protected static final ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID,
			"textures/entity/blackrose.png");

	public BlackroseRender(EntityRendererManager renderManagerIn) {
