...
public class AzureBalmungRender extends MobRenderer<NPCEntity, NPCModel<NPCEntity>> {

	protected static final ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID,
			"textures/entity/azurebalmung.png");

	public AzureBalmungRender(EntityRendererManager renderManagerIn) {
