...
public class SoraRender extends MobRenderer<NPCEntity, NPCModel<NPCEntity>> {

	protected static final ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID,
			"textures/entity/sora.png");

	public SoraRender(EntityRendererManager renderManagerIn) {
