...
public class AlkaidRender extends MobRenderer<NPCEntity, NPCModel<NPCEntity>> {

	protected static final ResourceLocation TEXTURE = new ResourceLocation(DotHackMod.MODID,
			"textures/entity/alkaid.png");

	public AlkaidRender(EntityRendererManager renderManagerIn) {
