...
public class AzureOrcaEntity extends NPCEntity {

	private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 1.2D, false) {
		public void resetTask() {
			super.resetTask();
			AzureOrcaEntity.this.setAggroed(false);
		}

		public void startExecuting() {
			super.startExecuting();
			AzureOrcaEntity.this.setAggroed(true);
		}
	};

	public AzureOrcaEntity(EntityType<AzureOrcaEntity> entityType, World worldIn) {
		super(entityType, worldIn);
		this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DotHackItems.BLADEBRANDIER9.get()));
		this.setCombatTask();
	}
	...
	public static boolean spawning(EntityType<AzureOrcaEntity> p_223337_0_, IWorld p_223337_1_, SpawnReason reason,
