...
public class AzureKiteEntity extends NPCEntity {

	private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 1.2D, false) {
		public void resetTask() {
			super.resetTask();
			AzureKiteEntity.this.setAggroed(false);
		}

		public void startExecuting() {
			super.startExecuting();
			AzureKiteEntity.this.setAggroed(true);
		}
	};

	public AzureKiteEntity(EntityType<AzureKiteEntity> entityType, World worldIn) {
		super(entityType, worldIn);
		this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DotHackItems.DUALSWORDS23.get()));
		this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(DotHackItems.DUALSWORDS23.get()));
		this.setCombatTask();
	}
	...
	public static boolean spawning(EntityType<AzureKiteEntity> p_223337_0_, IWorld p_223337_1_, SpawnReason reason,
