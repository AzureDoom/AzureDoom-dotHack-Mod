...
public class SoraEntity extends NPCEntity {

	private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 1.2D, false) {
		public void resetTask() {
			super.resetTask();
			SoraEntity.this.setAggroed(false);
		}

		public void startExecuting() {
			super.startExecuting();
			SoraEntity.this.setAggroed(true);
		}
	};

	public SoraEntity(EntityType<SoraEntity> entityType, World worldIn) {
		super(entityType, worldIn);
		this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DotHackItems.TWINBLADE48.get()));
		this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(DotHackItems.TWINBLADE48.get()));
		this.setCombatTask();
	}
	...
	public static boolean spawning(EntityType<SoraEntity> p_223337_0_, IWorld p_223337_1_, SpawnReason reason,
