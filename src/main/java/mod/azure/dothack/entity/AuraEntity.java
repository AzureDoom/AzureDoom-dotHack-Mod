...
public class AuraEntity extends NPCEntity {

	public AuraEntity(EntityType<AuraEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<AuraEntity> p_223337_0_, IWorld p_223337_1_, SpawnReason reason,
