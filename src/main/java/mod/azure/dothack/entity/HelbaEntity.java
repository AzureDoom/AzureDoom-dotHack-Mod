...
public class HelbaEntity extends NPCEntity implements IRangedAttackMob {

	private final RangedMagicAttackGoal<HelbaEntity> aiArrowAttack = new RangedMagicAttackGoal<>(this, 1.0D, 20, 15.0F);
	private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 1.2D, false) {
		public void resetTask() {
			super.resetTask();
			HelbaEntity.this.setAggroed(false);
		}

		public void startExecuting() {
			super.startExecuting();
			HelbaEntity.this.setAggroed(true);
		}
	};

	public HelbaEntity(EntityType<HelbaEntity> entityType, World worldIn) {
		super(entityType, worldIn);
		this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DotHackItems.WAVEMASTER43.get()));
		this.setCombatTask();
	}
	...
	public static boolean spawning(EntityType<HelbaEntity> p_223337_0_, IWorld p_223337_1_, SpawnReason reason,
	...
	protected ManaEntity fireArrowa(ItemStack arrowStack, float distanceFactor) {
		return HelbaEntity.fireArrow(this, arrowStack, distanceFactor);
	}
