...
public class BlackroseEntity extends NPCEntity {

	private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 1.2D, false) {
		public void resetTask() {
			super.resetTask();
			BlackroseEntity.this.setAggroed(false);
		}

		public void startExecuting() {
			super.startExecuting();
			BlackroseEntity.this.setAggroed(true);
		}
	};

	public BlackroseEntity(EntityType<BlackroseEntity> entityType, World worldIn) {
		super(entityType, worldIn);
		this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DotHackItems.HEAVYBLADE42.get()));
		this.setCombatTask();
	}
	...
	public static boolean spawning(EntityType<BlackroseEntity> p_223337_0_, IWorld p_223337_1_, SpawnReason reason,
