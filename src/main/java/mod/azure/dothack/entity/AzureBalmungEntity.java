...
public class AzureBalmungEntity extends NPCEntity {

	private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 1.2D, false) {
		public void resetTask() {
			super.resetTask();
			AzureBalmungEntity.this.setAggroed(false);
		}

		public void startExecuting() {
			super.startExecuting();
			AzureBalmungEntity.this.setAggroed(true);
		}
	};

	public AzureBalmungEntity(EntityType<AzureBalmungEntity> entityType, World worldIn) {
		super(entityType, worldIn);
		this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DotHackItems.BLADEBRANDIER10.get()));
		this.setCombatTask();
	}
	...
	public static boolean spawning(EntityType<AzureBalmungEntity> p_223337_0_, IWorld p_223337_1_, SpawnReason reason,
